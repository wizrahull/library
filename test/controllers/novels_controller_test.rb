...
class NovelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create novel" do
    assert_difference("Novel.count") do
      post novels_url, params: { novel: { author_id: @novel.author_id, name: @novel.name, pages: @novel.pages } }
    end
  ...
  test "should update novel" do
    patch novel_url(@novel), params: { novel: { author_id: @novel.author_id, name: @novel.name, pages: @novel.pages } }
